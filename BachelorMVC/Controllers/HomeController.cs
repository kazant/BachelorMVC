...
namespace BachelorMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult getAuth0()
        {
            ...
            request.AddParameter("application/json", "{\"user_metadata\": {\"godkjent\": \"0\"}}", ParameterType.RequestBody);
            //request.AddParameter("application/json", "{\"user_metadata\": {\"addresses\": {\"home\": \"123456 Main Streetssss, Anytown, ST 12345\"}}}", ParameterType.RequestBody);
